class quimera:
    def __init__(self, color, peso, altura, tamanio, sexo, temperamento, fuerza_de_mordedura, agilidad, grosor, pelaje):
        self.color = color
        self.peso = peso
        self.altura = altura
...
quimera1 = quimera("rojo", "7kg", "8.5m", "Enano", "machoo", "noble", "100", "10%", "105cm", "Suave")